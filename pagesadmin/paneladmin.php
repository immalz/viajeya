    ...
    <main class="main">
        ...
        <div class="card text-center container">
            <div class="card-header">
                AREA DE TRABAJO | ADMINISTRADOR
            </div>
            <div class="card-body">
                <h5 class="card-title">Ver registros</h5>
                <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Excepturi iure quo pariatur! Veniam autem atque molestiae fuga quia eligendi voluptate.</p>
                <img src="/NUEVATIENDA/assets/img/banner2.png">
                <br>
                <a href="/NUEVATIENDA/pagesadmin/reserva.php" class="btn btn-primary m-2">Empezar</a>
            </div>
